...
CONTROLPLANE_DOCKERFILE ?= service.controlplane.Dockerfile
DATAPLANE_DOCKERFILE ?= service.dataplane.Dockerfile
UDP_SERVER_DOCKERFILE ?= service.udp_server.Dockerfile
